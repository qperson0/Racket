...
(define(keyhand model key)
   (cond [(key=? key "up")    (packager (list (-y (first model)) (second model)))]
         [(key=? key "down")  (packager (list (+y (first model)) (second model)))]
         [(key=? key "right") (packager (list (+x (first model)) (second model)))]
         [(key=? key "left")  (packager (list (-x (first model)) (second model)))]
         [else model]))
